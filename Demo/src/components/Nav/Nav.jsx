...
const Nav = () => {
    return (<nav className='md:col-span-1 md:flex md:justify-end text-right'>
            <div className='text-sm mt-6 hidden md:block'>
                {/*<NavLink to="/profile" className={({ isActive }) => isActive ? 'text-gray-700 border-r-4 border-red-400 font-bold py-1 block' : "py-1 block border-r-4 border-transparent"}>*/}
                {/*    <span className='px-4 flex justify-end'>Profile</span>*/}
                {/*</NavLink>*/}
                {/*<NavLink to="/dialogs" className={({ isActive }) => isActive ? 'text-gray-700 border-r-4 border-red-400 font-bold py-1 block' : "py-1 block border-r-4 border-transparent"}>*/}
                {/*    <span className='px-4 flex justify-end'>Messages</span>*/}
                {/*</NavLink>*/}
